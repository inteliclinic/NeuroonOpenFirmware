...
#define ADS_OS_R0               0b0     //when reading 0 : Device is currently performing
                                        //a conversion
#define ADS_OS_R1               0b1     //when reading 1 : Device is not currently performing
                                        //a conversion
#define ADS_OS_W0               0b0     //When writing 0 : No effect
#define ADS_OS_W1               0b1     //When writing 1 : Start a single conversion
                                        //(when in power-down state)
...
#define ADS_COMP_LAT_0          0b0     //0 : Nonlatching comparator . The ALERT/RDY pin does not
                                        //latch when asserted (default)
#define ADS_COMP_LAT_1          0b1     //1 : Latching comparator. The asserted ALERT/RDY pin
                                        //remains latched until conversion data are read by the
                                        //master or an appropriate SMBus alert response is sent by
                                        //the master.
...
#define ADS_COMP_QUE_DIS        0b11	//11 : 11 : Disable comparator and set ALERT/RDY pin to
